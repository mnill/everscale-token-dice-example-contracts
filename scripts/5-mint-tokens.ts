...
async function main() {
  ...
  const mintTo = new Address("0:0003d61ce6267f4afd35f54b3ef50b250ff31eee8070ae925d66f22bbfaabe7a");

  // Put there address of the token root the previous script.
  const tokenRootAddress = '0:0009a4e459d673cde177b3818d0c67d73880891ef08411752e533f064fc575cb';
